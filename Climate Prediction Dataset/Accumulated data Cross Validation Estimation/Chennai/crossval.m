...
[traindata] = xlsread(fullfile('C:\Users\gokkul nath\Desktop\Ramanathan sir SVM\Coimbatore Climate Prediction\Accumulated data Cross Validation Estimation\Chennai\accumulated till 2015.xlsx')) ;
% [testdata] = xlsread(fullfile('C:\Users\gokkul nath\Desktop\Coimbatore Climate Prediction\Trichy\testdata2015.xlsx')) ;
...
folds = 10;
[C,gamma] = meshgrid(-5:3:15, -15:3:3);
