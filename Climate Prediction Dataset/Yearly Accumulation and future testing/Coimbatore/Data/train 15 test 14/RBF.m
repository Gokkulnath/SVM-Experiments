...
[traindata] = xlsread(fullfile('C:\Users\gokkul nath\Desktop\Ramanathan sir SVM\Climate Prediction\Data\train 11 test 10\traindata.xlsx')) ;
[testdata] = xlsread(fullfile('C:\Users\gokkul nath\Desktop\Ramanathan sir SVM\Climate Prediction\Data\train 11 test 10\testdata.xlsx')) ;
% read the data set
...
for i=1:numel(C)
    cv_acc(i) = svmtrain(labels, data, ...
                    sprintf('-s 0 -t 2 -h 0 -c %f -g %f -v %d ', 2^C(i), 2^gamma(i), folds));
end
...
model = svmtrain(labels, data, ...
                    sprintf('-s 0 -t 2 -h 0 -c %f -g %f -b 1', best_C, best_gamma));
